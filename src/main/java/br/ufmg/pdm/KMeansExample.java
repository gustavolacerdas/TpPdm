...
public class KMeansExample {
	...
	private static final String PATH_DATA = "/user/root/test/part-00000-of-00500.csv";
	private static final String PATH_MAP_BY_JOB_ID = "/user/root/test/recursosById.txt";
	private static final String PATH_GRUPO_CLUSTER = "/user/root/test/grupoClusters.txt";
	...
	private static void countByKey(JavaPairRDD<String, Vector> mapJobId){
		//Map<String, Object> contadores = mapJobId.countByKey();
		//JavaRDD<Long> count= new JavaRDD<Long>();
		System.out.println("Numero Apps"+mapJobId.count());
